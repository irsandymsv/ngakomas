    ...
    <div class="row">
      <div class="col-md-10">
        ...
        <div class="breadcrumb">
          ...
          <li><a href="../../controller/c_lihatPengumuman.php?id=<?php echo $pengumuman->id ?>">Detail Pengumuman</a></li>
          <li class="active">Ubah Pengumuman</li>
        </div>

        <div class="isi">
          <h2 style="text-align: center;">Ubah Pengumuman</h2>
          <br>
          <form method="POST" action="../../controller/c_editPengumuman.php" enctype="multipart/form-data">
            <div class="image">
            ...
            <div class="fields">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="kategori" style="width: 20%;">
                  ...
                  <?php foreach ($allKategori as $key) {
                    if ($key["id"] == $pengumuman->id_kategori) {
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="isi" rows="10"><?php echo $pengumuman->isi; ?>
                </textarea>
            ...
            <br>
            <div class="butt">
              <a class="btn btn-default" href="admLihatAnn.php" type="button" style=" margin-right: 5px; font-size:17px;;">Batal</a>
              <button  class="btn btn-warning" type="button" name="ubah" style="margin-right: 5px; font-size:17px;" data-toggle="modal" data-target="#myModal">Simpan</button>
            </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p>Apakah anda yakin ingin mengubah pengumuman ini?</p>
                  </div>
